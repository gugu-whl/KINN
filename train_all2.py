...
from resnet_iccnn_train2 import resnet_single_train
...
if __name__ == '__main__':
    ...
    parser.add_argument('-type', type=str, help='the type of train model ori/iccnn', default='iccnn')
    parser.add_argument('-is_multi', type=int, help='single/multi 0/1', default=0)
    parser.add_argument('-model', type=str, help='vgg/resnet/densenet', default='resnet')
